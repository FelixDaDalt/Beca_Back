...
import { AltaAdministrador, Comprobar, ObtenerAdministradores, NuevoTyc, ListadoTyc, SuspenderAdministrador, ObtenerAdministrador, BorrarAdministrador} from "../controllers/admin.controller";
